                ...
                <div>
                    ...
                    <div className="projects-container">
                        ...
                        <div className="project-items">
                            ...
                            <a href="bvidyanxttrendz.ccbp.tech" className="project-link">View Project</a>
                        </div>
                        </div>
                        ...
                        <div className="project-items">
                            ...
                            <a href="bvidyadhari.ccbp.tech" className="project-link">View Project</a>
                        </div>
                        </div>
                        ...
                        <div className="project-items">
                            ...
                            <a href="vidyajobbyapp.ccbp.tech" className="project-link">View Project</a>
                        </div>
                        </div>
